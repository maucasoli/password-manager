TRANSLATIONS = {
    "en": {
        ...
        "TITLE_RECOVER_CODE": "Recovery Code",
        # labels
        ...
        "LABEL_SHOW_RECOVERY_CODE": "This recovery code will be shown only once. Please store it in a safe place. If you lose it, it cannot be recovered.",
        ...
        "MSG_WRONG_CODE": "Incorrect recovery code",
    ...
    "fr": {
        ...
        "LABEL_RECOVERY_CODE": "Code de récupération",
        "LABEL_SHOW_RECOVERY_CODE": "Ce code de récupération ne sera affiché qu’une seule fois. Veuillez le conserver en lieu sûr. Il ne pourra pas être récupéré.",
        "LABEL_SERVICE": "Service",
        ...
        "MSG_WRONG_CODE": "Code de récupération incorrect",
